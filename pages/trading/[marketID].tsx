  ...
  const renderDesktop = useMemo(() => {
    return (
      <div className={cnWrapper}>
        <div className="toolbar relative h-1/6 max-h-16 w-full p-1">
          <div
            ref={toolbarRef}
            className="toolbar no-scrollbar flex h-full max-h-16 w-full items-center justify-between gap-4 overflow-x-auto overflow-y-hidden rounded border border-divider-color-20 bg-body-background-color shadow"
          >
        ...
        <div className="flex h-5/6 flex-grow flex-row">
          <div className="flex h-full w-full flex-grow flex-col md:w-3/5 xl:w-7/12">
            <div className="toolbar h-4/6 w-full px-1">
              <TradingChart />
            </div>
            <div className="toolbar h-2/6 w-full p-1">
              <OrdersWithPositions />
            </div>
          </div>
          <div className="flex h-full flex-col gap-1 pr-1 max-xl:max-w-[256px] md:w-2/5 xl:w-64 2xl:w-72">
            <div ref={orderFormRef} className="toolbar h-auto w-full">
              <OrderFormWidget />
            </div>
